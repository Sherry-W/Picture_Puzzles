var suggestedArray = [
  "../Picture_Puzzles/assets/images/numbers_9_pieces.jpg",
  "../Picture_Puzzles/assets/images/numbers_16_pieces.jpg",
  "../Picture_Puzzles/assets/images/numbers_25_pieces.jpg",
  "../Picture_Puzzles/assets/images/numbers_36_pieces.jpg",
  "../Picture_Puzzles/assets/images/spring.jpg",
  "../Picture_Puzzles/assets/images/summer.jpg",
  "../Picture_Puzzles/assets/images/Fall_700x400.jpg",
  "../Picture_Puzzles/assets/images/Winter.jpg",
  "../Picture_Puzzles/assets/images/daisies.jpg",
  "../Picture_Puzzles/assets/images/summerseason1.jpg",
  "../Picture_Puzzles/assets/images/beach.jpg",
  "../Picture_Puzzles/assets/images/Pembroke-Welsh-Corgi-MP.jpg",
  "../Picture_Puzzles/assets/images/img_800x480.jpg",
  "../Picture_Puzzles/assets/images/img_800x600.jpg",
  "../Picture_Puzzles/assets/images/earth_img_600x600.jpg",
  "../Picture_Puzzles/assets/images/sunset.jpg",
  "../Picture_Puzzles/assets/images/gradient-pixel-background.jpg"
];

for (var j = 0; j < suggestedArray.length; j++) {
  var suggestedImg = $("<img class='thumbnail'>").attr(
    "src",
    suggestedArray[j]
  );
...
$(document).on("click", ".thumbnail", function(event) {
  ...
  if (gameStarted == false) {
    ...
    $("#difficulty").remove();
    var newP = $("<p class='msg' id='difficulty'>").text(
...
$(document).on("click", ".completed", function(event) {
  ...
  $("#download").empty();
  var download = $("<a download target='_blank'>").attr(
    "href",
    $(this).attr("src")
  );
